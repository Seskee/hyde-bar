            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-16 border-t border-white/5 pt-16">
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-3">
                  ...
                  <h4 className="text-gold text-[10px] uppercase tracking-[0.4em] font-medium">{dict.barTitle}</h4>
                </div>
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-3">
                  ...
                  <h4 className="text-gold text-[10px] uppercase tracking-[0.4em] font-medium">{dict.kitchenTitle}</h4>
                </div>
                <ul className="text-[10px] uppercase tracking-[0.25em] text-white/30 space-y-5 font-light">
                  <li className="flex justify-between border-b border-white/10 pb-3">
