...
export default function MenuSection() {
  return (
    <section id="menu" className="w-full bg-[var(--bg-primary)] py-32">
      {/* Hero dio unutar Menu sekcije */}
      <div className="max-w-7xl mx-auto px-6 md:px-12 mb-32 grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
