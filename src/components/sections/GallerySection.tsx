...
const images = [
  { src: '/images/interijer1.webp', span: 'md:col-span-8', label: 'The Lounge' },
  ...
  { src: '/images/interijer4.webp', span: 'md:col-span-8', label: 'Details' },
]
    ...
    <section id="gallery" className="py-24 md:py-32 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          {images.map((img, i) => (
            <div key={i} className={`${img.span} relative h-[300px] md:h-[450px] overflow-hidden group border border-white/5`}>
              <Image
                src={img.src}
                alt={img.label}
                fill
