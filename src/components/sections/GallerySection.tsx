    ...
    <section id="gallery" className="py-24 md:py-48 px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="mb-20 reveal">
          <span className="text-gold text-[10px] tracking-[0.8em] uppercase block mb-6 opacity-50 font-medium">Atmosphere</span>
          <h2 className="font-heading text-5xl md:text-8xl text-white italic lowercase leading-none">Vibe</h2>
        </div>
